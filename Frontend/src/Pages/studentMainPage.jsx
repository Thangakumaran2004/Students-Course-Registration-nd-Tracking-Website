        ...
        <Container  >
                    <Row  className='justify-content-center'>
                        ...
                        <Col md={2}>
                            ...
                            <Row><b>DOB: </b></Row>
                            <Row><b>Year: </b></Row>
                            <Row><b>Semester: </b></Row>
                            <Row><b>Register No: </b></Row>
                        </Col>
                        <Col md={2}>
                            <Row><b>Total Credits :  </b></Row>
                            <Row><b>Credits Earned: </b></Row>
                            <Row><b>OE Credits: </b></Row>
                            <Row><b>PE Credits:  </b></Row>
                            <Row><b>Register No: </b></Row>
                        </Col>
              ...
              <tr key={id}>
                ...
                <Col md={4} className='staffdetails'>
                  <Container className='justify-content-center'>
                    ...
                    <span>Faculty 1</span><br />
                    <span>Faculty 2</span><br />
                    <span>Faculty 3</span><br />
                    <span>Course 2</span><br />
                    <span>Faculty 1</span><br />
                    <span>Faculty 2</span><br />
                    <span>Faculty 3</span><br />
                    </Container>
