...
export const  Dashboard= () => {
  ...
  let StudentDetails=sessionStorage.getItem('studentDetails');
 let  studentDetailsString=JSON.parse(StudentDetails);

 if (studentDetailsString !== null) {
  // Parse the JSON string to convert it into a JavaScript object
  let studentDetails = JSON.parse(studentDetailsString);
  console.log("Retrieved student details from session storage:", studentDetails);
