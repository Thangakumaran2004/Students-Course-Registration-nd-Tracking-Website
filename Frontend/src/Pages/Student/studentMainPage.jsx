...
const Studentpage = () => {
 ...
 let  studentDetailsString=JSON.parse(StudentDetails) ;
   ...
   const postStudentDetails=/*{'studentSemester':studentDetailsString.sem ,'studentYear':studentDetailsString.year,'studentBatch':studentDetailsString.batch,'studentDept':studentDetailsString.dept}*/0
