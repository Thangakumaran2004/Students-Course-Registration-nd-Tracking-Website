...
console.log("studentDetails ",studentDetailsString);
    if (studentDetailsString != null) {
     ...
     return (
       <div className='dashboard  p-4 mb-5  rounded   border-2   '>
           <Container  className=' justify-content-center dashcontainer ' style={     {background:'#0B0149 transparent',padding:'20px',width:'90%'}      }>
                       <Row  className='justify-content-center m-3'>
                           ...
                           <Row>Year:  {studentDetailsString.year}</Row>
                               ...
                               <Row>DOB: {studentDetailsString.sem}</Row>
                           </Col>
                       </Row>
           </Container>
           {/* <Container style={{width: '100%',backgroundColor: 'red'}}>
                <Row md={3} className='justify-content-center'>
                    ...
                    <Col md={4}>
                      ...
                      <Row>
                        <Col className='studendetailssubcol'>
                        <h5><i class="bi bi-ui-checks-grid"></i>PE Credits</h5>hello
                        </Col>
                        <Col className='studendetailssubcol'><h5><i class="bi bi-substack"></i>Batch</h5></Col>
                        <Col className='studendetailssubcol'>hello</Col>
                      </Row>
                    </Col> 
                </Row>            
           </Container> */}
